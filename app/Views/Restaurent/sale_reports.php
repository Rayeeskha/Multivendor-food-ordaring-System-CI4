...
<html>
<head>
	<title>Today Sale Reports</title>
	<!----------CSS FILE INCLUDE ----->
	<?= view('Restaurent/css_file'); ?>
	<!----------CSS FILE INCLUDE ----->
	<style type="text/css">
		td{font-size: 14px;color: black;font-weight: 500;}
	</style>
</head>
<body>
    		...
    		<div class="card-body" style="border-bottom: 1px solid silver">
				...
				<h6 style="color: grey;font-size: 15px; font-weight: 500;"> Date : 28-Feb-2021 To <?= date('d-M-Y'); ?> 
					<span style="margin-left: 65%;">
						<a href="<?= base_url('Restaurent/all_sales'); ?>" style="font-size: 15px;color: red;">
							Reset</a>
					</span>
				</h6>
				...
				<div class="modal fade" id="sale_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				  <div class="modal-dialog" role="document">
				    ...
				    <?= form_open('Restaurent/search_sales'); ?>
