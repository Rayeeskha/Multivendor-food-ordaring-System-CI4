	        ...
	        <div class="col-sm-12">
	            <div class="page-header ">
	                <div class="page-title">
	                    <h1>Order Details <span style="margin-left: 10%">Order date : <?= date('d M Y', strtotime($ord_details[0]->order_date)); ?></span></h1>
	                </div>
	            </div>
	        </div>
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-12 col-md-6 col-lg-6 col-sm-12">
						<?= form_open('Super_admin/change_order_status/'.$ord_details[0]->order_id); ?>
						...
						<a href="<?= base_url('Super_admin/print_order_slip/'.$ord_details[0]->order_id); ?>" class="btn btn-primary" target="_blank">Print Slip</a>
					...
					<div class="col-12 col-md-6 col-lg-6 col-sm-12">	
						...
						?>
					<?= form_open('Super_admin/add_order_del_boy/'. $ord_details[0]->order_id); ?>
